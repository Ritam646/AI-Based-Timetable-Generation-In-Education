...
class NegotiatorAgent:
    ...
    def negotiate(self, program="FYUP"):
        # For now, just return the generated timetable as "final"
        # In future, we can add real conflict resolution
        return {
            "message": "Negotiation complete (basic version)",
            "timetable": [],  # Frontend will use the already generated one
